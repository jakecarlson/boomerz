...
// Load this file's selection again by visiting: http://mootools.net/more/76ba6c348ca043889d6895b3cd7fd6bf 
// Or build this file again with packager using: packager build More/Fx.Elements More/Fx.Move More/Request.Periodical More/Assets
/*
---
copyrights:
...
this.store("move",a);}return a;}};Element.implement({move:function(a){this.get("move").start(a);return this;}});Request.implement({options:{initialDelay:5000,delay:5000,limit:60000},startTimer:function(b){var a=function(){if(!this.running){this.send({data:b});
